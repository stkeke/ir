...
EXAMPLE_EXES = $(EXAMPLES_BUILD_DIR)/0001-basic $(EXAMPLES_BUILD_DIR)/0001-while $(EXAMPLES_BUILD_DIR)/0005-basic-runner-func $(EXAMPLES_BUILD_DIR)/0006-if $(EXAMPLES_BUILD_DIR)/0007-min $(EXAMPLES_BUILD_DIR)/0008-var $(EXAMPLES_BUILD_DIR)/0008-varaddr
