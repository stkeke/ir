...
EXAMPLE_EXES = $(EXAMPLES_BUILD_DIR)/0001-basic $(EXAMPLES_BUILD_DIR)/0001-while $(EXAMPLES_BUILD_DIR)/0005-basic-runner-func $(EXAMPLES_BUILD_DIR)/0001-nop  $(EXAMPLES_BUILD_DIR)/0002-consts $(EXAMPLES_BUILD_DIR)/0003-compare  $(EXAMPLES_BUILD_DIR)/0004-negation $(EXAMPLES_BUILD_DIR)/0005-abs $(EXAMPLES_BUILD_DIR)/0006-bitcast $(EXAMPLES_BUILD_DIR)/0006-if $(EXAMPLES_BUILD_DIR)/0007-min $(EXAMPLES_BUILD_DIR)/0008-var $(EXAMPLES_BUILD_DIR)/0008-varaddr $(EXAMPLES_BUILD_DIR)/0009-alloca $(EXAMPLES_BUILD_DIR)/0010-loop $(EXAMPLES_BUILD_DIR)/0010-loop2 $(EXAMPLES_BUILD_DIR)/0011-mod $(EXAMPLES_BUILD_DIR)/0012-switch
...
cleanexample:
	rm -rf $(EXAMPLE_EXES) $(EXAMPLES_BUILD_DIR)/*.dot $(EXAMPLES_BUILD_DIR)/*.svg
